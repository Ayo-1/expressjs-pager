/*
 * pager
 * https://github.com/ayo-1/express-pager
 *
...
module.exports = function(options) {
	...
	if(options.template && options.template.ul && options.template.li && options.template.a && options.template.next && options.template.previous){
		var templates = {
			pagination: temp.main(options.template.ul),
			page: temp.page(options.template.li, options.page.a),
			next: temp.next(options.template.next, options.template.a, options.template.li),
			previous: temp.previous(options.template.previous, options.template.a, options.template.li),
